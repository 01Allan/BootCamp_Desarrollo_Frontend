...
function division(num1, num2){
    try {
        resultado = num1 / num2;
        if (resultado === Infinity) throw new Error("No se puede dividir por cero, intente de nuevo.");
        alert("La división de los números " + n1 + " y " + n2 + " es: " + resultado);
    } catch (error) {
        alert(error.message);
    }
...
while (opcion != 7) {
    ...
    if (opcion > 0 && opcion <= 7) {
        ...
        alert("Elección incorrecta, vuelva a intentar.")
    }
}
